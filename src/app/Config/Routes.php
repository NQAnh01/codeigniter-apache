...
$routes->group('admin', ['filter'=>AuthenticationFilter::class], function ($routes) {
    ...
    $routes->group('users', function ($routes) {
        ...
        $routes->post('create', 'Madmin\UserController::createUser', ['as'=>'admin.users.createUser']);
        $routes->get('edit/(:num)', 'Madmin\UserController::edit/$1', ['as'=>'admin.users.edit']);
        $routes->post('edit/(:num)', 'Madmin\UserController::update/$1');
        $routes->post('delete/(:num)', 'Madmin\UserController::destroy/$1', ['as'=>'admin.users.destroy']);
    });
});
