				...
				<div class="rd-navbar-main">
					...
					<div class="rd-navbar-panel">
						...
						<div class="rd-navbar-brand">
							<!--Brand--><a class="brand" href="../"><img class="brand-logo-dark" src="static/images/logo-default-280x92.png" alt="" width="140" height="46"/><img class="brand-logo-light" src="static/images/logo-inverse-280x92.png" alt="" width="140" height="46"/></a>
						</div>
					</div>
						...
						<ul class="rd-navbar-nav">
							<li class="rd-nav-item active"><a class="rd-nav-link" href="../">Home</a>
								<ul class="rd-menu rd-navbar-dropdown">
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="smoothie-shop.html">Smoothie Shop</a>
									</li>
									<li class="rd-dropdown-item active"><a class="rd-dropdown-link" href="index.html">Farm</a>
									</li>
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="fruit-farm.html">Fruit Farm</a>
									</li>
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="poultry-farm.html">Poultry Farm</a>
									</li>
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="winery.html">Winery</a>
									</li>
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="dairy-farm.html">Dairy Farm</a>
									</li>
								</ul>
							</li>
							...
							<li class="rd-nav-item"><a class="rd-nav-link" href="grid-blog.html">Blog</a>
								<ul class="rd-menu rd-navbar-dropdown">
									...
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="blog-list.html">Blog List</a>
									</li>
							...
							<li class="rd-nav-item"><a class="rd-nav-link" href="grid-gallery.html">Gallery</a>
								<ul class="rd-menu rd-navbar-dropdown">
									...
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="grid-fullwidth-gallery.html">Grid Fullwidth Gallery</a>
									</li>
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="masonry-gallery.html">Masonry Gallery</a>
									</li>
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="masonry-fullwidth-gallery.html">Masonry Fullwidth Gallery</a>
									</li>
								</ul>
							</li>
							<li class="rd-nav-item"><a class="rd-nav-link" href="#">Elements</a>
								<ul class="rd-menu rd-navbar-megamenu">
									...
									<li class="rd-megamenu-item rd-megamenu-banner">
										<div class="rd-megamenu-title"><span class="rd-megamenu-icon mdi mdi-carrot"></span><span class="rd-megamenu-text">Welcome to Our Store</span></div><a class="banner-classic" href="grid-shop.html"><img src="static/images/banner-1-300x202.jpg" alt="" width="300" height="202"/></a>
									</li>
								</ul>
							</li>
							<li class="rd-nav-item"><a class="rd-nav-link" href="grid-shop.html">Shop</a>
								<ul class="rd-menu rd-navbar-dropdown">
									<li class="rd-dropdown-item"><a class="rd-dropdown-link" href="ecwid-shop.html">Ecwid Shop</a>
									</li>
								...
								<div class="cart-inline-body">
									<div class="cart-inline-item">
										<div class="unit unit-spacing-sm align-items-center">
											<div class="unit-left"><a class="cart-inline-figure" href="single-product.html"><img src="static/images/product-mini-6-100x90.png" alt="" width="100" height="90"/></a></div>
											<div class="unit-body">
									...
									<div class="cart-inline-item">
										<div class="unit unit-spacing-sm align-items-center">
											<div class="unit-left"><a class="cart-inline-figure" href="single-product.html"><img src="static/images/product-mini-7-100x90.png" alt="" width="100" height="90"/></a></div>
											<div class="unit-body">
					...
					<div class="rd-navbar-project">
						...
						<div class="rd-navbar-project-content">
							<div>
								<div>
									<!-- Owl Carousel-->
									<div class="owl-carousel" data-items="1" data-dots="true" data-autoplay="true"><img src="static/images/about-5-350x269.jpg" alt="" width="350" height="269"/><img src="static/images/about-6-350x269.jpg" alt="" width="350" height="269"/><img src="static/images/about-7-350x269.jpg" alt="" width="350" height="269"/>
									</div>
