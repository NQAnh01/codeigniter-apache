...
<section class="section swiper-container swiper-slider swiper-slider-1" data-loop="true">
	<div class="swiper-wrapper context-dark text-center">
		<div class="swiper-slide" data-slide-bg="static/images/slide-1.jpg">
			<div class="swiper-slide-caption section-md">
				<div class="container">
					<h4 class="swiper-title-3" data-caption-animate="fadeInLeft" data-caption-delay="200">Welcome to Our Farm</h4>
					<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Products</h1>
					<h3 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="200">Grown with love</h3>
					<div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"><a class="button button-lg button-shadow-3 button-secondary button-zakaria" href="grid-shop.html">Shop now</a></div>
				</div>
			</div>
		</div>
		<div class="swiper-slide" data-slide-bg="static/images/slide-2.jpg">
			<div class="swiper-slide-caption section-md">
				<div class="container">
		...
		<div class="swiper-slide" data-slide-bg="static/images/slide-3.jpg">
			<div class="swiper-slide-caption section-md">
				<div class="container">
					<h4 class="swiper-title-3" data-caption-animate="fadeInLeft" data-caption-delay="200">Fresh Organic Produce</h4>
...
<!-- About Us-->
<section class="section section-inset-2 bg-default text-md-start">
	<div class="container">
		<div class="row row-30 align-items-center justify-content-center justify-content-xl-between">
			<div class="col-sm-6 col-md-5 col-lg-6 wow fadeInLeft"><img src="static/images/about-8-576x410.jpg" alt="" width="576" height="410"/>
			</div>
			<div class="col-md-7 col-lg-6 col-xl-5">
				...
				<div class="group-xl group-middle d-md-flex justify-content-md-between wow fadeInRight" data-wow-delay=".3s">
					...
					</div><img src="static/images/signature-1-160x55.png" alt="" width="160" height="55"/>
				</div>
			</div>
		</div>
	</div>
...
<!-- Services-->
<section class="parallax-container" data-parallax-img="static/images/parallax-3.jpg">
			...
			<div class="row row-30 box-ordered">
				<div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".3s">
					<article class="box-icon-modern">
						...
						<h4 class="box-icon-modern-title"><a href="#">Always Fresh</a></h4>
				...
				<div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".2s">
					<article class="box-icon-modern">
						...
						<h4 class="box-icon-modern-title"><a href="#">100% organic</a></h4>
				...
				<div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".1s">
					<article class="box-icon-modern">
						...
						<h4 class="box-icon-modern-title"><a href="#">No additives</a></h4>
				...
				<div class="col-sm-6 col-lg-3 wow fadeInLeft">
					<article class="box-icon-modern">
						...
						<h4 class="box-icon-modern-title"><a href="#">Modern farm</a></h4>
			...
			<div class="row row-30 row-lg-50 isotope">
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 2">
					...
					<article class="product wow fadeInRight">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-1-220x160.png" alt="" width="220" height="160"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 1">
					...
					<article class="product wow fadeInRight" data-wow-delay=".1s">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-2-191x132.png" alt="" width="191" height="132"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 1">
					...
					<article class="product wow fadeInRight" data-wow-delay=".2s">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-3-238x158.png" alt="" width="238" height="158"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 1">
					...
					<article class="product wow fadeInRight" data-wow-delay=".3s">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-7-210x168.png" alt="" width="210" height="168"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 3">
					...
					<article class="product wow fadeInLeft" data-wow-delay=".3s">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-4-204x125.png" alt="" width="204" height="125"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 2">
					...
					<article class="product wow fadeInLeft" data-wow-delay=".2s">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-5-204x156.png" alt="" width="204" height="156"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 1">
					...
					<article class="product wow fadeInLeft" data-wow-delay=".1s">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-6-237x156.png" alt="" width="237" height="156"/>
							</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 isotope-item" data-filter="Type 3">
					...
					<article class="product wow fadeInLeft">
						<div class="product-body">
							<div class="product-figure"><img src="static/images/product-8-210x133.png" alt="" width="210" height="133"/>
							</div>
...
<section class="section section-xxl bg-image-3 image-decor-wrap">
		...
		<div class="owl-carousel owl-style-3" data-items="1" data-margin="200" data-autoplay="true" data-nav="true" data-dots="true" data-smart-speed="400" data-animation-in="fadeIn" data-animation-out="fadeOut">
			...
			<article class="quote-modern quote-modern-2">
				...
				<div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
					<div class="unit-left">
						<div class="quote-modern-figure"><img src="static/images/user-11-62x62.jpg" alt="" width="62" height="62"/>
						</div>
					</div>
					<div class="unit-body">
			...
			<article class="quote-modern quote-modern-2">
				...
				<div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
					<div class="unit-left">
						<div class="quote-modern-figure"><img src="static/images/user-10-62x62.jpg" alt="" width="62" height="62"/>
						</div>
					</div>
					<div class="unit-body">
			...
			<article class="quote-modern quote-modern-2">
				...
				<div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
					<div class="unit-left">
						<div class="quote-modern-figure"><img src="static/images/user-6-62x62.jpg" alt="" width="62" height="62"/>
						</div>
					</div>
					<div class="unit-body">
	...
	</div><img class="image-decor-left" src="static/images/bg-image-2.png" alt=""/><img class="image-decor-right" src="static/images/bg-image-3.png" alt=""/>
</section>
<!-- Banner-->
<section class="section section-xxl bg-default">
	<div class="container">
		<div class="row row-30">
			<div class="col-sm-7 wow fadeInLeft"><a class="banner-modern-figure block-1" href="grid-shop.html"><img src="static/images/banner-2-670x676.jpg" alt="" width="670" height="676"/></a></div>
			<div class="col-sm-5"><a class="banner-modern-figure block-1 wow fadeInRight" href="grid-shop.html"><img src="static/images/banner-3-470x395.jpg" alt="" width="470" height="395"/></a><a class="banner-modern-figure block-1 wow fadeInRight" href="grid-shop.html"><img src="static/images/banner-4-470x250.jpg" alt="" width="470" height="250"/></a></div>
		</div>
	</div>
</section>
<!-- Our team-->
<section class="section section-fluid section-xxl section-bottom-0 bg-image-1">
	<div class="container-fluid">
		...
		<div class="owl-carousel owl-style-4" data-items="1" data-sm-items="2" data-xl-items="3" data-xxl-items="4" data-nav="true" data-margin="30" data-mouse-drag="false">
			<article class="team-amy block-1"><a class="team-amy-figure" href="#"><img src="static/images/team-11-420x450.png" alt="" width="420" height="450"/></a>
				<div class="team-amy-caption">
					<div class="team-amy-text">Hi! I’m</div>
					<h5 class="team-amy-name"><a href="#">Rick Simmons</a></h5>
			...
			<article class="team-amy block-1"><a class="team-amy-figure" href="#"><img src="static/images/team-12-420x450.png" alt="" width="420" height="450"/></a>
				<div class="team-amy-caption">
					<div class="team-amy-text">Hi! I’m</div>
					<h5 class="team-amy-name"><a href="#">Jane Peterson</a></h5>
			...
			<article class="team-amy block-1"><a class="team-amy-figure" href="#"><img src="static/images/team-13-420x450.png" alt="" width="420" height="450"/></a>
				<div class="team-amy-caption">
					<div class="team-amy-text">Hi! I’m</div>
					<h5 class="team-amy-name"><a href="#">Sam Williams</a></h5>
			...
			<article class="team-amy block-1"><a class="team-amy-figure" href="#"><img src="static/images/team-14-420x450.png" alt="" width="420" height="450"/></a>
				<div class="team-amy-caption">
					<div class="team-amy-text">Hi! I’m</div>
					<h5 class="team-amy-name"><a href="#">Kate McMillan</a></h5>
...
<section class="section section-sm section-first bg-default text-md-start">
	<div class="container">
		<div class="row row-30 justify-content-center align-items-md-center">
					...
					<div class="product-wrap-1 bg-image-1 block-1">
						...
						<div class="owl-carousel owl-style-5" data-items="1" data-margin="30" data-dots="true" data-autoplay="true">
							<article class="product-creative">
								<div class="product-figure"><img src="static/images/product-big-4-470x324.png" alt="" width="470" height="324"/>
								</div>
							...
							<article class="product-creative">
								<div class="product-figure"><img src="static/images/product-big-5-470x324.png" alt="" width="470" height="324"/>
								</div>
							...
							<article class="product-creative">
								<div class="product-figure"><img src="static/images/product-big-6-470x324.png" alt="" width="470" height="324"/>
								</div>
				...
				<div class="card-group-custom card-group-custom-1 card-group-corporate" id="accordion1" role="tablist" aria-multiselectable="false">
					...
					<article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".2s">
						<div class="card-header" role="tab">
							<div class="card-title"><a id="accordion1-card-head-gnexgldj" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#accordion1-card-body-vgcplqkd" aria-controls="accordion1-card-body-vgcplqkd" aria-expanded="true" role="button">What does &quot;organic&quot; mean?
									<div class="card-arrow">
										<div class="icon"></div>
									</div></a></div>
						</div>
						<div class="collapse show" id="accordion1-card-body-vgcplqkd" aria-labelledby="accordion1-card-head-gnexgldj" data-bs-parent="#accordion1" role="tabpanel">
							<div class="card-body">
					...
					<article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".3s">
						<div class="card-header" role="tab">
							<div class="card-title"><a class="collapsed" id="accordion1-card-head-egdslnun" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#accordion1-card-body-ghuiacod" aria-controls="accordion1-card-body-ghuiacod" aria-expanded="false" role="button">Why eat organic?
									<div class="card-arrow">
										<div class="icon"></div>
									</div></a></div>
						</div>
						<div class="collapse" id="accordion1-card-body-ghuiacod" aria-labelledby="accordion1-card-head-egdslnun" data-bs-parent="#accordion1" role="tabpanel">
							<div class="card-body">
					...
					<article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".4s">
						<div class="card-header" role="tab">
							<div class="card-title"><a class="collapsed" id="accordion1-card-head-rvvchjkw" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#accordion1-card-body-rckirepx" aria-controls="accordion1-card-body-rckirepx" aria-expanded="false" role="button">Is organic food healthier?
									<div class="card-arrow">
										<div class="icon"></div>
									</div></a></div>
						</div>
						<div class="collapse" id="accordion1-card-body-rckirepx" aria-labelledby="accordion1-card-head-rvvchjkw" data-bs-parent="#accordion1" role="tabpanel">
							<div class="card-body">
			...
			<div class="col-xl-12">
				<div class="owl-carousel owl-style-6" data-items="2" data-sm-items="3" data-md-items="4" data-lg-items="5" data-margin="30" data-dots="true"><a class="clients-classic" href="#"><img src="static/images/clients-1-120x114.png" alt="" width="120" height="114"/></a><a class="clients-classic" href="#"><img src="static/images/clients-2-105x118.png" alt="" width="105" height="118"/></a><a class="clients-classic" href="#"><img src="static/images/clients-3-111x98.png" alt="" width="111" height="98"/></a><a class="clients-classic" href="#"><img src="static/images/clients-4-122x92.png" alt="" width="122" height="92"/></a><a class="clients-classic" href="#"><img src="static/images/clients-5-112x112.png" alt="" width="112" height="112"/></a></div>
			</div>
		</div>
	</div>
</section>
...
<section class="section section-sm section-last bg-default">
	<div class="container">
		...
		<h2 class="wow fadeScale">Dairy Farm</h2>
	</div>
	<!-- Owl Carousel-->
	<div class="owl-carousel owl-style-7" data-items="1" data-sm-items="2" data-xl-items="3" data-xxl-items="4" data-nav="true" data-dots="true" data-margin="30" data-autoplay="true">
		<!-- Post Creative-->
		<article class="post post-creative block-1"><a class="post-creative-figure" href="blog-post.html"><img src="static/images/post-10-420x368.jpg" alt="" width="420" height="368"/></a>
		...
		<!-- Post Creative-->
		<article class="post post-creative block-1"><a class="post-creative-figure" href="blog-post.html"><img src="static/images/post-11-420x368.jpg" alt="" width="420" height="368"/></a>
			<div class="post-creative-content">
		...
		<!-- Post Creative-->
		<article class="post post-creative block-1"><a class="post-creative-figure" href="blog-post.html"><img src="static/images/post-12-420x368.jpg" alt="" width="420" height="368"/></a>
			<div class="post-creative-content">
		...
		<!-- Post Creative-->
		<article class="post post-creative block-1"><a class="post-creative-figure" href="blog-post.html"><img src="static/images/post-13-420x368.jpg" alt="" width="420" height="368"/></a>
			<div class="post-creative-content">
		...
		<!-- Post Creative-->
		<article class="post post-creative block-1"><a class="post-creative-figure" href="blog-post.html"><img src="static/images/post-14-420x368.jpg" alt="" width="420" height="368"/></a>
			<div class="post-creative-content">
